...
public interface DonationBeanLocal {
	...
	List<DataDonation> getDonationsuser(List<DataSearchFilter> resultDonations) throws XPathExpressionException, SAXException, IOException, ParserConfigurationException;
