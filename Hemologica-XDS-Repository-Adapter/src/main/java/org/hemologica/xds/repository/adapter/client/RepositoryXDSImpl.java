package org.hemologica.xds.repository.adapter.client;
...
import org.hemologica.xds.repository.adapter.repositorioxds.Adocumentrepository;
import org.hemologica.xds.repository.adapter.repositorioxds.AdocumentrepositoryServicesService;
import org.hemologica.xds.repository.adapter.repositorioxds.DocumentType;
import org.hemologica.xds.repository.adapter.repositorioxds.DocumentsRequest;
import org.hemologica.xds.repository.adapter.repositorioxds.ExtrinsicObjectType;
import org.hemologica.xds.repository.adapter.repositorioxds.PROVIDEANDREGISTERDOCUMENTSET;
import org.hemologica.xds.repository.adapter.repositorioxds.RegistryPackageType;
import org.hemologica.xds.repository.adapter.repositorioxds.RegistryResponseType;
import org.hemologica.xds.repository.adapter.repositorioxds.SubmitObjectsRequest;
import org.hemologica.xds.repository.adapter.repositorioxds.SubmitObjectsRequestRegistryObjectList;
...
public class RepositoryXDSImpl implements IRepositoryXDS {
	...
	private URL SOAP_URL;
	private QName SOAP_QName;

	@Override
	public void saveCDA(String authorPerson, String authorInstitution, String authorRole, String codingSchemeLOINCId,
			String codingSchemeLOINCname, String codingSchemeSNOMEDCTId, String codingSchemeSNOMEDCTName,
			String languageCode, String PID5, String PID7, String PID8, String cdaID, String cdaDocumentType,
			String cda, String submissionTime) {
		...
		PROVIDEANDREGISTERDOCUMENTSET pro = getProvideAndRegisterDocumentSet(authorPerson, authorInstitution,
				authorRole, codingSchemeLOINCId, codingSchemeLOINCname, codingSchemeSNOMEDCTId,
				codingSchemeSNOMEDCTName, PID5, PID7, PID8, languageCode, cdaID, cdaDocumentType, cda, submissionTime);
		...
		try {
			...
			RegistryResponseType response = adocumentrepository
					.provideandregisterdocumentset(pro.getSubmitobjectsrequest(), pro.getDocumentsrequest());
	...
	private PROVIDEANDREGISTERDOCUMENTSET getProvideAndRegisterDocumentSet(String authorPerson,
			String authorInstitution, String authorRole, String codingSchemeLOINCId, String codingSchemeLOINCname,
			String codingSchemeSNOMEDCTId, String codingSchemeSNOMEDCTName, String PID5, String PID7, String PID8,
		...
		/**
		 * ExtrinsicObject.Classification - XDSDocumentEntry.author -
		...
		// <Value
		// xmlns="">1234567^PEREZ^JUAN^^^^^^^^^&amp;2.16.858.0.2.16.86.1.0.0.212567060019.0001&amp;ISO</Value>
		// </Slot>co
		...
		// <Value
		// xmlns="">ASESP^^^^^^^^^2.16.858.0.2.16.86.1.0.0.212567060019</Value>
		// </Slot>
		...
		/**
		 * ExtrinsicObject.Classification - XDSDocumentEntry.classCode -
		 * urn:uuid:41a5887f-8865-4c09-adf7-e362475b143a Tipo de Documento - Nos
		 * faltan loc codigos
		 */
		...
		classificationClassCode.setNodeRepresentation(codingSchemeLOINCId); // CODIGO
																			// LOINC
																			// DEL
																			// DOCUMENTO
		...
		/**
		 * ExtrinsicObject.Classification - XDSDocumentEntry.confidentialityCode
		 * - urn:uuid:f4f85eac-e6cb-4883-b524-f2705394840f
		 */

		/**
		 * ExtrinsicObject.Classification - XDSDocumentEntry.formatCode -
		 * urn:uuid:a09d5840-386c-46f2-b5ad-9c3699a4309d
		 */

		/**
		 * ExtrinsicObject.Classification - XDSDocumentEntry.typeCode -
		 * urn:uuid:f0306f51-975f-434e-a61c-c59651d33983 SNOMED-CT
		 * procedimiento?
		 */
		...
		classificationTypeCode.setNodeRepresentation(codingSchemeSNOMEDCTId); // CODIGO
																				// SNOMEDCT
																				// DEL
																				// DOCUMENTO
		// Mismo que XDSDocumentEntry.author
		...
		/**
		 * ExtrinsicObject.ExternalIdentifierType - XDSDocumentEntry.patientId -
		...
		/**
		 * ExtrinsicObject.ExternalIdentifierType - XDSDocumentEntry.uniqueId -
		...
		/**
		 * RegistryPackage.Classification XDSSubmissionSet.author -
		...
		/**
		 * RegistryPackage.Classification XDSSubmissionSet.contentTypeCode -
		...
		/**
		 * ExtrinsicObject.ExternalIdentifierType - XDSSubmissionSet.uniqueId -
		...
		/**
		 * ExtrinsicObject.ExternalIdentifierType - XDSSubmissionSet.sourceId -
		...
		/**
		 * ExtrinsicObject.ExternalIdentifierType - XDSSubmissionSet.patientId -
	...
	public URL getSOAP_URL() {
		return SOAP_URL;
	}

	public void setSOAP_URL(URL sOAP_URL) {
		SOAP_URL = sOAP_URL;
	}

	public QName getSOAP_QName() {
		return SOAP_QName;
	}

	public void setSOAP_QName(QName sOAP_QName) {
		SOAP_QName = sOAP_QName;
	}
