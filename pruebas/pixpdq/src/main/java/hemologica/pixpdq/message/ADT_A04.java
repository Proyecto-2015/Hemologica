...
public class ADT_A04 extends AbstractMessage {
	...
	private ca.uhn.hl7v2.model.v231.message.ADT_A04 adt;
	private Patient patient;
	private static final String MESSAGE_TYPE = "ADT";
	private static final String MESSAGE_STRUCTURE = "ADT_A04";
	private static final String MESSAGE_TRIGGER_EVENT = "A04";
	...
	public ADT_A04(Patient patient) throws HL7Exception {
		
		adt = new ca.uhn.hl7v2.model.v231.message.ADT_A04();
	...
	public AbstractSegment createMSH() throws HL7Exception {
		...
		mshSegment.getMessageType().getTriggerEvent().setValue(ADT_A04.MESSAGE_TRIGGER_EVENT);
		mshSegment.getMessageType().getMessageStructure().setValue(ADT_A04.MESSAGE_STRUCTURE);
		mshSegment.getMessageType().getMessageType().setValue(ADT_A04.MESSAGE_TYPE);
		mshSegment.getVersionID().getVersionID().setValue(ADT_A04.MESSAGE_VERSION);
