...
public class ADT_A40 {

//	private ca.uhn.hl7v2.model.v231.message.ADT_A40 adt;
//	private Patient patient;
//	
//	private static final String MESSAGE_TYPE = "ADT";
//	private static final String MESSAGE_STRUCTURE = "ADT_A40";
//	private static final String MESSAGE_TRIGGER_EVENT = "A40";
...
//
//	public ADT_A40(Patient patient) throws HL7Exception {
//		
//		adt = new ca.uhn.hl7v2.model.v231.message.ADT_A40();
//		
...
//		mshSegment.getMessageType().getTriggerEvent().setValue(ADT_A40.MESSAGE_TRIGGER_EVENT);
//		mshSegment.getMessageType().getMessageStructure().setValue(ADT_A40.MESSAGE_STRUCTURE);
//		mshSegment.getMessageType().getMessageType().setValue(ADT_A40.MESSAGE_TYPE);
//		mshSegment.getVersionID().getVersionID().setValue(ADT_A40.MESSAGE_VERSION);
