...
insert into `hemologica`.`movements` (`movement_date`,`movement_id`,`movements_types_id`,`units_id`) values
...
insert into `hemologica`.`units` (`unit_institution_code`,`unit_uuid`,`unit_institution_center_id`,`unit_type`,`unit_state`,`unit_parent`,`blood_abo_type`,`blood_rh_type`) values
